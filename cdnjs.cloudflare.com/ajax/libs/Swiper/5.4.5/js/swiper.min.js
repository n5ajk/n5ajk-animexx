...
!(function (e, t) {
  ...
  function H(e) {
              ...
              (this.isVertical() && a.currentX === a.startX)
                ...
                : c * c + u * u >= 25 &&
                  ...
                  (t.isScrolling = this.isHorizontal()
                    ...
                    : 90 - v > s.touchAngle));
            if (
              (t.isScrolling && this.emit("touchMoveOppoSika ANIME", o),
    ...
    } else t.startMoving && t.isScrolling && this.emit("touchMoveOppoSika ANIME", o);
  }
  function B(e) {
    var t = this,
      i = t.touchEventsData,
      ...
      init: function () {
        ...
        if (t.el) {
          ...
          0 !== i.length &&
            ...
            "progressbar" === t.type &&
              t.progressbarOppoSika ANIME &&
              i.addClass(t.progressbarOppoSika ANIMEClass),
            t.clickable &&
      ...
      },
      {
        ...
        params: {
          pagination: {
            ...
            progressbarOppoSika ANIMEClass: "swiper-pagination-progressbar-oppoSika ANIME",

!(function (e) {
  ...
  function (e, t, i) {
    ...
    ((l = c || (c = {}))[(l.InvalidAppId = 0)] = "InvalidAppId"),
      ...
      (l[(l.WrongSika ANIMEUrl = 3)] = "WrongSika ANIMEUrl"),
      ...
      constructor(e, t) {
        ...
        switch (e) {
          ...
          case c.MissingSubdomain:
            ...
            break;
          case c.WrongSika ANIMEUrl:
            i =
              t && t.Sika ANIMEUrl
                ? `OneSignal: This web push config can only be used on ${
                    new URL(t.Sika ANIMEUrl).origin
                  }.` + ` Your current origin is ${location.origin}.`
                : "OneSignal: This web push config can not be used on the current Sika ANIME.";
            break;
    ...
    class C {
      static isCategorySlidedownConfigured(e) {
        if (!e) return !1;
        const t = C.getFirstSlidedownPromptOptionsWithType(e, O.Category);
    ...
    class A {
      ...
      getReportedNotificationPermission(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          if (h.a.useSafariLegacyPush())
            return A.getSafariNotificationPermission(e);
          if (I.b.isUsingSubscriptionWorkaround())
      ...
      isPermissionEnvironmentAmbiguous(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          const t = I.b.redetectBrowserUserAgent();
          return (
            !t.safari &&
            !t.firefox &&
            e === y.Denied &&
            (this.isCurrentFrameContextCrossOrigin() ||
              (yield T.a.isFrameContextInsecure()) ||
              I.b.isUsingSubscriptionWorkaround())
          );
        });
      }
    ...
    class k {
      ...
      static getLocalPageViewCount() {
        return Number(localStorage.getItem(x));
      }
    }
    const j = {
      ...
      _ = { toastText: "onesignal-toast-text" },
      D = { toastText: "onesignal-toast-text" },
      R = {
        allowButton: "onesignal-slidedown-allow-button",
        body: "slidedown-body",
        buttonIndicatorHolder: "onesignal-button-indicator-holder",
      ...
      B = { taggingContainer: "tagging-container" },
      L =
      ...
      F = { greyLoadingIndicator: "#95A1AC", whiteLoadingIndicator: "#FFFFFF" },
      H = { fetchingPreferences: "Fetching your preferences" },
      $ = {
      ...
      q = {
        containerSelector: `.${z.containerClass}`,
        subscribeSelector: `.${z.subscribeClass}`,
        explanationSelector: `.${z.explanationClass}`,
      };
    var K = i(2);
    class Y {
      constructor(e) {
          ...
          if (
            ...
            if (
              ...
              (null === (t = this.config) || void 0 === t
                ? void 0
                : t.unsubscribeEnabled) || !Y.isPushEnabled())
            )
          ...
          if (null === (t = this.config) || void 0 === t ? void 0 : t.text) {
            if (this.config.text.explanation) {
              ...
              (t.textContent = this.config.text.explanation),
                Object(K.a)(t, z.resetClass),
                Object(K.a)(t, z.explanationClass),
                this.config.size && Object(K.a)(t, this.config.size),
                Y.isPushEnabled()
                  ? Object(K.a)(t, z.state.subscribed)
                  : Object(K.a)(t, z.state.unsubscribed),
                e.appendChild(t);
            }
        ...
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          if (null === (t = this.config) || void 0 === t ? void 0 : t.text) {
            if (this.config.text.subscribe) {
              ...
              Object(K.a)(t, z.resetClass),
                Object(K.a)(t, z.subscribeClass),
                this.config.size && Object(K.a)(t, this.config.size),
                this.config.style && Object(K.a)(t, this.config.style),
                Y.isPushEnabled()
                  ? Object(K.a)(t, z.state.subscribed)
                  : Object(K.a)(t, z.state.unsubscribed),
      ...
      setTextFromPushStatus(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          void 0 === i
            ? void 0
            : i.subscribe) &&
            (Y.isPushEnabled() || (e.textContent = this.config.text.subscribe)),
            (null ===
              (o =
      ...
      get customlinkContainerElements() {
        const e = document.querySelectorAll(q.containerSelector);
        return Array.prototype.slice.call(e);
      }
      static isPushEnabled() {
        return k.getIsPushNotificationsEnabled();
      }
      static isOptedOut() {
        return k.getIsOptedOut();
      }
    }
    class J {
      static onNotificationPermissionChange() {
        J.checkAndTriggerSubscriptionChanged();
      }
      ...
      static checkAndTriggerSubscriptionChanged() {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          (null === n || t !== n) &&
            ...
            k.setIsPushNotificationsEnabled(t),
            (i.lastKnownPushEnabled = t),
            yield w.a.setAppState(i),
            J.triggerSubscriptionChanged(t));
        });
      }
      static _onSubscriptionChanged(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          J.onSubscriptionChanged_showWelcomeNotification(e),
            J.onSubscriptionChanged_sendCategorySlidedownTags(e),
            J.onSubscriptionChanged_evaluateNotifyButtonDisplayPredicate(),
            J.onSubscriptionChanged_updateCustomLink();
        });
      }
        ...
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          const n =
            null ===
              ...
              ? void 0
              : i.prompts;
          C.isCategorySlidedownConfigured(n) &&
      ...
      static onSubscriptionChanged_showWelcomeNotification(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          if (!0 !== e) return;
          if (J.sendingOrSentWelcomeNotification) return;
          J.sendingOrSentWelcomeNotification = !0;
          let i =
          ...
          const o = new URL(location.href).origin + "?_osp=do_not_open",
            s = t && t.url && t.url.length > 0 ? t.url : o;
          (i = P.a.decodeHtmlEntities(i)),
            (n = P.a.decodeHtmlEntities(n)),
      ...
      static fireStoredNotificationClicks(e = document.URL) {
        return Object(d.a)(this, void 0, void 0, function* () {
          function t(e) {
            return Object(d.a)(this, void 0, void 0, function* () {
              const t = yield w.a.getAppState();
              (t.clickedNotifications[e.url] = null), yield w.a.setAppState(t);
          ...
          const i = yield w.a.getAppState();
          if (
            "origin" ===
            (yield w.a.get("Options", "notificationClickHandlerMatch"))
          ) {
    ...
    J.sendingOrSentWelcomeNotification = !1;
    var Q,
      Z,
      X = i(6);
    class ee {
      static promiseStub() {
        return { then: ee.promiseStub, catch: ee.promiseStub };
      }
      static ensureBackwardsCompatibility(e) {
        ee.environmentPolyfill(e),
          ee.postmams(e),
          (e.syncHashedEmail = ee.promiseStub);
      }
      static environmentPolyfill(e) {
        (e.environment = {}),
          ...
          (e.environment.isPopup = function () {
            return T.a.getWindowEnv() === X.a.OneSignalSubscriptionPopup;
          }),
    ...
    class ie {
      ...
      getDeliveryPlatform() {
        const e = I.a.redetectBrowserUserAgent();
    ...
    class ne extends ie {
      ...
      static createFromPushSubscription(e, t, i) {
        ...
        return (
          (n.appId = e),
          (n.subscriptionState = t ? Q.Subscribed : Q.NotSubscribed),
    ...
    var oe,
      ...
      re = i(17),
      ae = i(5);
    ((se = oe || (oe = {}))[(se.Blocked = 0)] = "Blocked"),
      (se[(se.Dismissed = 1)] = "Dismissed"),
      (se[(se.Default = 2)] = "Default");
    class ce extends p.a {
      constructor(e) {
        ...
        super(t), (this.reason = e), Object.setPrototypeOf(this, ce.prototype);
      }
    }
    class le {
      isNewSubscription() {
      ...
      static deserialize(e) {
        ...
        return (
          ...
          e.existingW3cPushSubscription
            ? (t.existingW3cPushSubscription = le.deserialize(
                e.existingW3cPushSubscription
              ))
    ...
    class ge {
      static registerForPush() {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          return yield ge.internalRegisterForPush(e);
        });
      }
      static internalRegisterForPush(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          if (e && !t.pageViewManager.isFirstPageView()) {
            ...
            const e = yield he.getDeviceId();
            if (e) {
              const t = yield he.createDeviceRecord(OneSignal.config.appId, !0);
          ...
          switch (T.a.getWindowEnv()) {
            case X.a.Host:
            case X.a.OneSignalSubscriptionModal:
              try {
                ...
                (i = yield t.subscriptionManager.registerSubscription(e)),
                  ...
                  yield re.a.triggerNotificationPermissionChanged(),
                  yield J.checkAndTriggerSubscriptionChanged();
              } catch (e) {
                E.a.info(e);
              }
              break;
                    ...
                    case oe.Blocked:
                      yield t.permissionManager.updateStoredPermission(),
                        OneSignal.subscriptionPopup.message(
                          ...
                          { permission: y.Denied, forceUpdatePermission: !1 }
                        );
                      break;
                    case oe.Dismissed:
                      OneSignal.subscriptionPopup.message(
                        OneSignal.POSTMAM_COMMANDS
                          .REMOTE_NOTIFICATION_PERMISSION_CHANGED,
                        { permission: y.Default, forceUpdatePermission: !0 }
                      );
                  }
      ...
      static getRawPushSubscriptionFromServiceWorkerRegistration(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          return t ? le.setFromW3cSubscription(t) : null;
        });
      }
      ...
      static getRawPushSubscription(e, t) {
        return Object(d.a)(this, void 0, void 0, function* () {
          if (e.browserType === de.Safari)
            return ge.getRawPushSubscriptionForSafari(t);
          if (e.isUsingSubscriptionWorkaround)
            return ge.getRawPushSubscriptionWhenUsingSubscriptionWorkaround();
          if (e.isBrowserAndSupportsServiceWorkers) {
            const e =
              yield OneSignal.context.serviceWorkerManager.getRegistration();
            return yield ge.getRawPushSubscriptionFromServiceWorkerRegistration(
              e
            );
          }
          return null;
    ...
    class he {
      static getCurrentNotificationType() {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          if (e === y.Default) return Q.Default;
          if (e === y.Denied)
            return I.a.isUsingSubscriptionWorkaround()
              ? Q.Default
              : Q.NotSubscribed;
          const t =
      ...
      static getNotificationTypeFromOptIn(e) {
        return 1 == e || null == e ? Q.Subscribed : Q.MutedByApi;
      }
      ...
      static checkAndTriggerNotificationPermissionChanged() {
        return Object(d.a)(this, void 0, void 0, function* () {
          const e = yield w.a.get("Options", "notificationPermission"),
            t = yield OneSignal.getNotificationPermission();
          e !== t &&
            (yield re.a.triggerNotificationPermissionChanged(),
            yield w.a.put("Options", {
              key: "notificationPermission",
              value: t,
            }));
        });
      ...
      static getNotificationIcons() {
        return Object(d.a)(this, void 0, void 0, function* () {
          const e = yield he.getAppId();
          if (!e) throw new m(o.MissingAppId);
          const t = `${T.a.getOneSignalApiUrl().toString()}/apps/${e}/icon`,
            i = yield (yield fetch(t)).json();
          if (i.errors)
            throw (
              (E.a.error(
                `API call %c${t}`,
                ae.a.getConsoleStyle("code"),
                "failed with:",
                i.errors
              ),
      ...
      static getSlidedownOptions(e) {
        return ae.a.getValueOrDefault(e.slidedown, { prompts: [] });
      }
      ...
      static getPromptOptionsQueryString() {
        let e = "";
        if (
          he.getFullscreenPermissionMessageOptions(
            OneSignal.config.userConfig.promptOptions
          )
        ) {
          const t = he.getPromptOptionsPostHash();
      ...
      static getPromptOptionsPostHash() {
        const e = he.getFullscreenPermissionMessageOptions(
          OneSignal.config.userConfig.promptOptions
        );
        if (e) {
          var t = {
      ...
      static getAppId() {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          return yield w.a.get("Ids", "appId");
        });
      }
      static createDeviceRecord(e, t = !1) {
        return Object(d.a)(this, void 0, void 0, function* () {
          let i;
          if (t) {
            const e = yield ge.getRawPushSubscription(
          ...
          return (
            (n.appId = e),
            (n.subscriptionState = yield he.getCurrentNotificationType()),
            n
          );
        });
      }
    ...
    class fe {
      ...
      onWindowMessagePostmanConnectReceived(e) {
        const t = T.a.getWindowEnv().toString();
        if (
          (E.a.debug(
          ...
          i === fe.HANDSHAKE_MESSAGE
            ? (E.a.info(
              ...
              this.message(fe.CONNECTED_MESSAGE),
      ...
      connect() {
        E.a.info(
          ...
          this.windowReference.postMessage(
            { handshake: fe.HANDSHAKE_MESSAGE },
            this.sendToOrigin,
            [this.channel.port2]
          );
      }
      ...
      reply(e, t, i) {
        const n = {
          ...
          command: e.command,
          data: t,
          source: T.a.getWindowEnv().toString(),
          isReply: !0,
        };
      ...
      isSafeOrigin(e) {
        ...
        return (
          ...
          e === T.a.getOneSignalApiUrl().origin ||
    ...
    class Se {
      ...
      load() {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          (this.url = T.a.getOneSignalApiUrl()),
            ...
            (this.url.search = `${he.getPromptOptionsQueryString()}&id=${
              this.appId
      ...
      establishCrossOriginMessaging() {
        (this.messenger = new fe(this.modal, this.url.origin, this.url.origin)),
      ...
      onModalAccepted(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          E.a.debug("User accepted the HTTPS modal prompt.", location.origin),
            ...
            this.dispose(),
            he.triggerCustomPromptClicked("granted"),
            E.a.debug("Calling setSubscription(true)"),
            yield ge.registerForPush(),
            yield OneSignal.setSubscription(!0);
        });
      }
      onModalRejected(e) {
        E.a.debug("User rejected the HTTPS modal prompt."),
          (OneSignal._sessionInitAlreadyRunning = !1),
          this.dispose(),
          he.triggerCustomPromptClicked("denied");
      }
      onModalClosing(e) {
    ...
    ((me = pe || (pe = {})).WorkerVersion = "GetWorkerVersion"),
      (me.Subscribe = "Subscribe"),
      (me.SubscribeNew = "SubscribeNew"),
      (me.AmpSubscriptionState = "amp-web-push-subscription-state"),
      (me.AmpSubscribe = "amp-web-push-subscribe"),
      (me.AmpUnsubscribe = "amp-web-push-unsubscribe"),
      (me.NotificationDisplayed = "notification.displayed"),
      (me.NotificationClicked = "notification.clicked"),
      (me.NotificationDismissed = "notification.dismissed"),
      (me.RedirectPage = "command.redirect"),
      (me.SessionUpsert = "os.session.upsert"),
      (me.SessionDeactivate = "os.session.deactivate"),
      (me.AreYouVisible = "os.page_focused_request"),
      (me.AreYouVisibleResponse = "os.page_focused_response"),
      (me.SetLogging = "os.set_sw_logging");
    class Oe {
      constructor() {
        this.replies = {};
      }
    ...
    class ye {
      ...
      broadcast(e, t) {
        return Object(d.a)(this, void 0, void 0, function* () {
          if (T.a.getWindowEnv() !== X.a.ServiceWorker) return;
      ...
      unicast(e, t, i) {
        return Object(d.a)(this, void 0, void 0, function* () {
          if (T.a.getWindowEnv() === X.a.ServiceWorker) {
            if (!i)
              throw new InvalidArgumentError.a(
                "windowClient",
                InvalidArgumentError.b.Empty
      ...
      directPostMessageToSW(e, t) {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          const n = ve.getAvailableServiceWorker(i);
          n
            ? n.postMessage({ command: e, payload: t })
            : E.a.error(
      ...
      listen() {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          T.a.getWindowEnv() === X.a.ServiceWorker
    ...
    class we {
      ...
      loadSdkStylesheet() {
        return Object(d.a)(this, void 0, void 0, function* () {
          const e = T.a.getOneSignalResourceUrlPath(),
            t = T.a.getOneSignalCssFileName();
        ...
        return Object(d.a)(this, void 0, void 0, function* () {
          return (
            this.cache[t.toString()] ||
              (this.cache[t.toString()] = we.load(e, t)),
    ...
    class Ae {
      ...
      show() {
        return this.hidden
          ? new Promise((e) => {
              (this.state = "showing"), S.a.trigger(Ae.EVENTS.SHOWING, this);
              const t = this.element;
              if (
                (t
                  ? (this.hideClass && Object(K.v)(t, this.hideClass),
                    this.showClass && Object(K.a)(t, this.showClass))
                  : E.a.error(
              ...
              Object(K.u)(
                ...
                (t, n) => {
                  if (
                    ...
                    Object(K.f)(this.targetTransitionEvents, t.propertyName)
                  )
                    return (
                      clearTimeout(i),
                      n(),
                      (this.state = "shown"),
                      S.a.trigger(Ae.EVENTS.SHOWN, this),
                      e(this)
                    );
                },
                !0
      ...
      hide() {
        return this.shown
          ? new Promise((e) => {
              (this.state = "hiding"), S.a.trigger(Ae.EVENTS.HIDING, this);
              const t = this.element;
              if (
                (t
                  ? (this.showClass && Object(K.v)(t, this.showClass),
                    this.hideClass && Object(K.a)(t, this.hideClass))
                  : E.a.error(
                ...
                (t, i) => {
                  ...
                  if (
                    ...
                    return (
                      ...
                      i(),
                      (this.state = "hidden"),
                      S.a.trigger(Ae.EVENTS.HIDDEN, this),
                      e(this)
                    );
                },
                !0
      ...
      waitUntilShown() {
        return "shown" === this.state
          ? Promise.resolve(this)
          : new Promise((e) => {
              Bi.emitter.once(Ae.EVENTS.SHOWN, (t) => {
      ...
      waitUntilHidden() {
        return "hidden" === this.state
          ? Promise.resolve(this)
          : new Promise((e) => {
              Bi.emitter.once(Ae.EVENTS.HIDDEN, (t) => {
                if (t === this) return e(this);
              });
            });
      }
    ...
    class Me extends Ae {
        ...
        return this.inactive && this.shown
          ? new Promise((e) => {
              (this.activeState = "activating"),
                S.a.trigger(Me.EVENTS.ACTIVATING, this);
              const t = this.element;
              if (
                (t
                  ? (this.inactiveClass && Object(K.v)(t, this.inactiveClass),
                    this.activeClass && Object(K.a)(t, this.activeClass))
                ...
                return (
                  ...
                  S.a.trigger(Me.EVENTS.ACTIVE, this),
                  e(this)
                );
        ...
        return this.active
          ? new Promise((e) => {
              (this.activeState = "inactivating"),
                S.a.trigger(Me.EVENTS.INACTIVATING, this);
              const t = this.element;
              if (
                (t
                  ? (this.activeClass && Object(K.v)(t, this.activeClass),
                    this.inactiveClass && Object(K.a)(t, this.inactiveClass))
                  : E.a.error("Could not find active animated element"),
                !this.shown)
              )
                return (
                  (this.activeState = "inactive"),
                  S.a.trigger(Me.EVENTS.INACTIVE, this),
                  e(this)
                );
              if (0 == this.targetTransitionEvents.length) return e(this);
              var i = setTimeout(() => {
      ...
      waitUntilActive() {
        return this.active
          ? Promise.resolve(this)
          : new Promise((e) => {
              Bi.emitter.once(Me.EVENTS.ACTIVE, (t) => {
                if (t === this) return e(this);
              });
            });
      }
      waitUntilInactive() {
        return this.inactive
          ? Promise.resolve(this)
          : new Promise((e) => {
              Bi.emitter.once(Me.EVENTS.INACTIVE, (t) => {
                if (t === this) return e(this);
              });
            });
      }
      static get EVENTS() {
        return Object.assign(Object.assign({}, Ae.EVENTS), {
    ...
    class xe extends Ae {
      ...
      display(e, t, i = 0) {
        return (
          ...
          (this.shown ? this.hide() : Object(K.t)())
            .then(() => {
      ...
      getTipForState() {
        return this.bell.state === $e.STATES.UNSUBSCRIBED
          ? this.bell.options.text["tip.state.unsubscribed"]
          : this.bell.state === $e.STATES.SUBSCRIBED
          ? this.bell.options.text["tip.state.subscribed"]
          : this.bell.state === $e.STATES.BLOCKED
          ? this.bell.options.text["tip.state.blocked"]
          : "";
      }
      enqueue(e) {
        return (
          this.queued.push(Object(K.g)(e)),
          new Promise((e) => {
    ...
    class ke extends Me {
      ...
      onHovering() {
        (v.isEmpty(this.events.mouse) ||
          ...
          S.a.trigger($e.EVENTS.HOVERING),
          v.put(this.events.mouse, "over");
      }
      onHovered() {
        v.put(this.events.mouse, "out"), S.a.trigger($e.EVENTS.HOVERED);
      }
      onTap() {
      ...
      onClick() {
        if (
          (S.a.trigger($e.EVENTS.BELL_CLICK),
          S.a.trigger($e.EVENTS.LAUNCHER_CLICK),
          !this.bell.message.shown ||
            this.bell.message.contentType != xe.TYPES.MESSAGE)
        ) {
      ...
      updateBellLauncherDialogBody() {
        return OneSignal.getSubscription().then((e) => {
          ...
          if (
            ...
            (this.bell.state === $e.STATES.SUBSCRIBED && !0 === e) ||
              (this.bell.state === $e.STATES.UNSUBSCRIBED && !1 === e))
          ) {
            let e = "";
            const n = Object(K.m)(this.notificationIcons);
            e =
              "default-icon" != n
          ...
          } else if (this.bell.state === $e.STATES.BLOCKED) {
            let e = null;
            g.a.chrome
    ...
    class _e extends Me {
      ...
      resize(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          if (
            ("small" === e &&
              Object(K.o)(this.element, "onesignal-bell-launcher-sm")) ||
            ("medium" === e &&
              Object(K.o)(this.element, "onesignal-bell-launcher-md")) ||
            ("large" === e &&
              Object(K.o)(this.element, "onesignal-bell-launcher-lg"))
          )
            return Promise.resolve(this);
          if (
            (Object(K.v)(this.element, "onesignal-bell-launcher-sm"),
            Object(K.v)(this.element, "onesignal-bell-launcher-md"),
            Object(K.v)(this.element, "onesignal-bell-launcher-lg"),
            "small" === e)
          )
            Object(K.a)(this.element, "onesignal-bell-launcher-sm");
          else if ("medium" === e)
            Object(K.a)(this.element, "onesignal-bell-launcher-md");
          else {
            if ("large" !== e)
                ...
                Object(K.u)(
                  ...
                  (i, n) => {
                    if (
                      ...
                      Object(K.f)(this.targetTransitionEvents, i.propertyName)
                    )
    ...
    class De {
      ...
      static setItem(e, t, i) {
        if (!De.isLocalStorageSupported()) return;
      ...
      static getItem(e) {
        if (!De.isLocalStorageSupported()) return null;
    ...
    const Re = {
        [Ee.Push]: Ie.PromptDismissCount,
        [Ee.NonPush]: Ie.NonPushPromptsDismissCount,
      },
      Ue = {
        [Ee.Push]: Pe.OneSignalNotificationPrompt,
        [Ee.NonPush]: Pe.OneSignalNonPushPrompt,
      };
    class We {
      static markPromptDismissedWithType(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          const t = Re[e],
            i = Ue[e];
          let n = yield w.a.get("Options", t);
          n || (n = 0), Object(K.q)() || (n += 1);
          let o = 3;
          2 == n ? (o = 7) : n > 2 && (o = 30),
            E.a.debug(
              `(${T.a
            ...
            yield w.a.put("Options", { key: t, value: n });
          const s = 24 * o * 60;
          return De.setItem(i, "dismissed", s);
        });
      }
      static wasPromptOfTypeDismissed(e) {
        switch (e) {
          case Ee.Push:
            return "dismissed" === De.getItem(Pe.OneSignalNotificationPrompt);
          case Ee.NonPush:
            return "dismissed" === De.getItem(Pe.OneSignalNonPushPrompt);
        }
        return !1;
      }
    }
    ...
    class $e {
      ...
      setDefaultTextOptions(e) {
        return {
          ...
          "dialog.main.title":
            e["dialog.main.title"] || "Manage Sika ANIME Notifications",
      ...
      installEventHooks() {
        Bi.emitter.on($e.EVENTS.SUBSCRIBE_CLICK, () => {
          ...
          Bi.emitter.on($e.EVENTS.UNSUBSCRIBE_CLICK, () => {
          ...
          Bi.emitter.on($e.EVENTS.HOVERED, () => {
            this.message.contentType !== xe.TYPES.MESSAGE &&
              this.dialog.hidden &&
              (this.hovering &&
                ((this.hovering = !1),
          ...
          Bi.emitter.on(Bi.EVENTS.SUBSCRIPTION_CHANGED, (e) =>
            Object(d.a)(this, void 0, void 0, function* () {
              if (
                ...
                const e = yield he.getNotificationIcons();
              ...
              Bi.getNotificationPermission((t) => {
                ...
                (i = e
                  ...
                  : t === y.Denied
                  ? $e.STATES.BLOCKED
                  : $e.STATES.UNSUBSCRIBED),
                  this.setState(i, this._ignoreSubscriptionState);
              });
            })
          ),
          Bi.emitter.on($e.EVENTS.STATE_CHANGED, (e) => {
            this.launcher.element &&
              (e.to === $e.STATES.SUBSCRIBED
                ? this.launcher.inactivate()
                : (e.to === $e.STATES.UNSUBSCRIBED || $e.STATES.BLOCKED) &&
      ...
      addDefaultClasses() {
        ...
        if ("bottom-left" === this.options.position)
          e && Object(K.a)(e, "onesignal-bell-container-bottom-left"),
            Object(K.a)(
          ...
          e && Object(K.a)(e, "onesignal-bell-container-bottom-right"),
            Object(K.a)(
              this.launcher.selector,
      ...
      create() {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          this.container && Object(K.w)("#onesignal-bell-container"),
            Object(K.b)(
              "body",
              "beforeend",
            ...
            Object(K.b)(this.button.selector, "beforeend", He);
          const e = yield Bi.isPushNotificationsEnabled(),
            t = yield Bi.getSubscription(),
            i = We.wasPromptOfTypeDismissed(Ee.Push),
          ...
          yield this.launcher.resize(n),
            ...
            yield (e ? this.launcher.inactivate() : Object(K.t)())
              .then(() => Bi.getSubscription())
              .then((t) =>
                (!e && t) || null !== this.dialog.notificationIcons
                  ? Object(K.t)()
                  : he.getNotificationIcons().then((e) => {
                      this.dialog.notificationIcons = e;
                    })
              )
              .then(() => Object(K.i)(this.options.showLauncherAfter || 0))
              .then(() =>
                Object(K.q)() &&
                t &&
                !0 !== i &&
              ...
              .then(() => Object(K.i)(this.options.showBadgeAfter || 0))
              .then(() =>
      ...
      updateState() {
        Promise.all([
          ...
          this.setState(e ? $e.STATES.SUBSCRIBED : $e.STATES.UNSUBSCRIBED),
            t === y.Denied && this.setState($e.STATES.BLOCKED);
        });
      }
      setState(e, t = !1) {
        const i = this.state;
        (this.state = e),
          i === e ||
            t ||
            S.a.trigger($e.EVENTS.STATE_CHANGED, { from: i, to: e });
      }
      get container() {
      ...
      get launcher() {
        return (
          this._launcher || (this._launcher = new _e(this)), this._launcher
        );
      }
      get button() {
        return this._button || (this._button = new ke(this)), this._button;
      }
      get badge() {
        return this._badge || (this._badge = new Ne()), this._badge;
      }
      get message() {
        return this._message || (this._message = new xe(this)), this._message;
      }
      get dialog() {
        return this._dialog || (this._dialog = new je(this)), this._dialog;
      }
      get subscribed() {
    ...
    class Ge {
      ...
      load() {
        const e = Object.assign(
          Object.assign({}, he.getPromptOptionsPostHash()),
          {
            promptType: "popup",
      ...
      onFinishingRegistrationRemotely(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          this.messenger && this.messenger.stopPostMessageReceive(),
            ...
            yield J.checkAndTriggerSubscriptionChanged(),
            yield he.checkAndTriggerNotificationPermissionChanged();
        });
      }
    ...
    class Ke {}
    ((Le = Be || (Be = {})).HttpPermissionRequest = "HttpPermissionRequest"),
      (Le.SyncHashedEmail = "SyncHashedEmail");
    class Ye extends qe {
      constructor(e) {
    ...
    class Qe {
      ...
      reportEvent(e) {
        ...
        const t = {
          ...
          i = ze(JSON.stringify(t)),
          n = { method: "GET", headers: new Headers(), cache: "no-cache" };
        return fetch(`${Qe.MIXPANEL_REPORTING_URL}/track/?data=${i}`, n);
      }
      reportEngagement(e) {
        if (!this.isEnabled()) return Promise.resolve(null);
        let t = {
        ...
        const i = ze(JSON.stringify(t)),
          n = { method: "GET", headers: new Headers(), cache: "no-cache" };
        return fetch(`${Qe.MIXPANEL_REPORTING_URL}/engage/?data=${i}`, n);
      }
    ...
    ((Fe = Ve || (Ve = {}))[(Fe.HttpPermissionRequest = 0)] =
      "HttpPermissionRequest"),
      (Fe[(Fe.SyncHashedEmail = 1)] = "SyncHashedEmail");
    class Ze extends p.a {
      constructor(e) {
        let t, i;
        switch (e) {
          case Ve.HttpPermissionRequest:
            (t =
              "The HTTP permission request has been deprecated. Please remove any custom popups from your code."),
              (i = Be.HttpPermissionRequest);
            break;
          case Ve.SyncHashedEmail:
            (t =
      ...
      reportUsage(e) {
        "undefined" != typeof OneSignal &&
          ...
          OneSignal.context.metricsManager.reportEvent(new Ye(e));
      }
    }
    class Xe {
      static internalInit() {
        return Object(d.a)(this, void 0, void 0, function* () {
          E.a.debug("Called %cinternalInit()", Object(K.k)("code")),
          ...
          OneSignal.emitter.on(
            ...
            "visible" === document.visibilityState
              ? yield Xe.sessionInit()
              : Xe.postponeSessionInitUntilPageIsInFocus();
        });
      }
      static postponeSessionInitUntilPageIsInFocus() {
        Object(K.u)(
          ...
          "visibilitychange",
          (e, t) => {
            "visible" === document.visibilityState && (t(), Xe.sessionInit());
          },
          !0
        );
      }
      static sessionInit() {
        return Object(d.a)(this, void 0, void 0, function* () {
          if (
            (E.a.debug("Called %csessionInit()", Object(K.k)("code")),
          ...
          k.setIsOptedOut(!!e),
            I.a.isUsingSubscriptionWorkaround() ||
              (yield Xe.handleAutoResubscribe(e));
      ...
      static registerForPushNotifications(e = {}) {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          if (I.a.isUsingSubscriptionWorkaround())
            return e.httpPermissionRequest
              ? void E.a.error(new Ze(Ve.HttpPermissionRequest))
              : void (yield Xe.loadSubscriptionPopup(e));
          k.getIsOptedOut() || (yield ge.registerForPush());
        });
      }
      static onSdkInitialized() {
        return Object(d.a)(this, void 0, void 0, function* () {
          const e = yield Xe.processExpiringSubscriptions();
          (yield OneSignal.context.subscriptionManager.isAlreadyRegisteredWithOneSignal())
      ...
      static loadSubscriptionPopup(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          (OneSignal.subscriptionPopupHost = new Ge(
      ...
      static storeInitialValues() {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          v.put("subscription.optedOut", i),
            yield w.a.put("Options", { key: "isPushEnabled", value: e }),
            yield w.a.put("Options", {
              key: "notificationPermission",
              value: t,
            });
      ...
      static setWelcomeNotificationFlag() {
        return Object(d.a)(this, void 0, void 0, function* () {
          (yield OneSignal.context.permissionManager.getNotificationPermission(
            OneSignal.context.appConfig.safariWebId
          )) === y.Granted && (OneSignal.__doNotShowWelcomeNotification = !0);
        });
      }
      ...
      static processExpiringSubscriptions() {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          const t = yield T.a.getIntegration(),
            i = T.a.getWindowEnv();
          switch (
            (E.a.debug(
            ...
            case Ce.a.InsecureProxy:
              yield w.a.remove("Ids", "registrationId"),
                E.a.debug(
      ...
      static registerSubscriptionInProxyFrame(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          const t = yield new Promise((t) => {
            e.workerMessenger.once(pe.SubscribeNew, (e) => {
              t(Te.a.deserialize(e));
            }),
              e.workerMessenger.unicast(pe.SubscribeNew, e.appConfig);
          });
          return (
      ...
      static doInitialize() {
        return Object(d.a)(this, void 0, void 0, function* () {
          const e = [];
          e.push(Xe.storeInitialValues()),
            e.push(Xe.installNativePromptPermissionChangedHook()),
            e.push(Xe.setWelcomeNotificationFlag()),
            e.push(Xe.establishServiceWorkerChannel()),
            e.push(Xe.showNotifyButton()),
            e.push(Xe.showPromptsFromWebConfigEditor());
          try {
            yield Promise.all(e);
          } catch (e) {
      ...
      static showPromptsFromWebConfigEditor() {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          e.userConfig.promptOptions &&
            (yield new Y(e.userConfig.promptOptions.customlink).initialize());
        });
      }
        ...
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          return (
            [
              ...
              i && i[t]
                ? e.push(
                    w.a.put("Options", { key: `webhooks.${t}`, value: i[t] })
                  )
                : e.push(
                    w.a.put("Options", { key: `webhooks.${t}`, value: !1 })
                  );
            }),
            i && i.cors
              ? e.push(w.a.put("Options", { key: "webhooks.cors", value: !0 }))
              : e.push(w.a.put("Options", { key: "webhooks.cors", value: !1 })),
      ...
      static initSaveState(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          const t = yield he.getAppId(),
            i = OneSignal.config;
          yield w.a.put("Ids", { type: "appId", id: t });
          const n = e || i.Sika ANIMEName || document.title || "Notification";
          yield w.a.put("Options", { key: "pageTitle", value: n }),
      ...
      static handleAutoResubscribe(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          if (
            ...
            (yield OneSignal.context.permissionManager.getNotificationPermission(
              OneSignal.context.appConfig.safariWebId
            )) == y.Granted && (yield ge.registerForPush());
          }
        });
      }
      static polyfillSafariFetch() {
        return Object(d.a)(this, void 0, void 0, function* () {
          if (g.a.safari && void 0 === window.fetch) {
            ...
            try {
              yield new we().loadFetchPolyfill(),
    ...
    class et {
      ...
      getPageViewCount() {
        try {
          const e = sessionStorage.getItem(et.SESSION_STORAGE_KEY_NAME),
            t = e ? parseInt(e) : 0;
          return isNaN(t) ? 0 : t;
        } catch (e) {
          return 0;
      ...
      setPageViewCount(e) {
        try {
          sessionStorage.setItem(et.SESSION_STORAGE_KEY_NAME, e.toString()),
            T.a.getWindowEnv() === X.a.OneSignalSubscriptionPopup &&
    ...
    et.SESSION_STORAGE_KEY_NAME = "onesignal-pageview-count";
    class tt {
      constructor(e) {
        if (!e)
          throw new InvalidArgumentError.a(
      ...
      getWithoutQueryString() {
        return this.path.split(tt.QUERY_STRING)[0];
      }
      getFileName() {
        var e;
    ...
    class st {
      static get(e, t, i) {
        return st.call("GET", e, t, i);
      }
      static post(e, t, i) {
        return st.call("POST", e, t, i);
      }
      static put(e, t, i) {
        return st.call("PUT", e, t, i);
      }
      static delete(e, t, i) {
        return st.call("DELETE", e, t, i);
      }
      static call(e, t, i, n) {
        if ("GET" === e) {
          if (t.indexOf("players") > -1 && -1 === t.indexOf("app_id="))
            return (
              ...
              Promise.reject(new ot.a(ot.b.MissingAppId))
            );
        ...
        return (
          ...
          fetch(T.a.getOneSignalApiUrl(void 0, t).toString() + "/" + t, s)
            .then((e) => ((r = e.status), e.json()))
            .then((e) => {
              if (r >= 200 && r < 300) return e;
              if ("no-user-id-error" !== st.identifyError(e))
      ...
      static identifyError(e) {
        ...
        const t = e.errors;
        return ae.a.contains(t, "No user with this id found") ||
          ae.a.contains(t, "Could not find app_id for given player id.")
          ? "no-user-id-error"
          : "unknown-error";
      }
    }
    ...
    class ct {
        ...
        return (
          ...
          st
            .post("players", {
              ...
              device_type: t,
              identifier: i,
              notification_types: Q.TemporaryWebRecord,
            })
      ...
      static updatePlayer(e, t, i) {
        return Object(d.a)(this, void 0, void 0, function* () {
          return yield ae.a.enforceAppIdAndPlayerId(e, t, () =>
            Object(d.a)(this, void 0, void 0, function* () {
              yield st.put(`players/${t}`, Object.assign({ app_id: e }, i));
            })
          );
        });
      }
      static updateUserSession(e, t) {
        return Object(d.a)(this, void 0, void 0, function* () {
          return yield ae.a.enforceAppIdAndPlayerId(t.app_id, e, () =>
            Object(d.a)(this, void 0, void 0, function* () {
              const i = yield st.post(`players/${e}/on_session`, t);
              return i.id ? i.id : e;
            })
          );
        });
      ...
      static sendSessionDuration(e, t, i, n, o) {
        return Object(d.a)(this, void 0, void 0, function* () {
          ae.a.enforceAppIdAndPlayerId(e, t, () =>
            Object(d.a)(this, void 0, void 0, function* () {
              const s = {
                app_id: e,
                type: 1,
              ...
              yield st.post(`players/${t}/on_focus`, s);
            })
          );
        });
      }
    ...
    const ut = "sendOutcome",
      gt = "sendUniqueOutcome";
    class ht {
      constructor(e, t, i, n) {
        (this.outcomeName = i),
          (this.config = t),
      ...
      getAttribution() {
        return Object(d.a)(this, void 0, void 0, function* () {
          return yield ht.getAttribution(this.config);
        });
      }
      beforeOutcomeSend() {
        return Object(d.a)(this, void 0, void 0, function* () {
          const e = this.isUnique ? gt : ut;
          return (
            Object(K.s)(e, this.outcomeName),
            this.config
              ? this.outcomeName
                ? (yield Object(K.c)(),
      ...
      getAttributedNotifsByUniqueOutcomeName() {
        return Object(d.a)(this, void 0, void 0, function* () {
          return (yield w.a.getAll("SentUniqueOutcome"))
      ...
      shouldSendUnique(e, t) {
        return e.type === rt.Unattributed || t.length > 0;
      }
      saveSentUniqueOutcome(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          const t = this.outcomeName,
            i = yield w.a.get("SentUniqueOutcome", t),
            n = yield w.a.getCurrentSession(),
            o = [...(i ? i.notificationIds : []), ...e],
            s = n ? n.startTimestamp : null;
          yield w.a.put("SentUniqueOutcome", {
            outcomeName: t,
            notificationIds: o,
            sentDuringSession: s,
          });
      ...
      wasSentDuringSession() {
        return Object(d.a)(this, void 0, void 0, function* () {
          const e = yield w.a.get("SentUniqueOutcome", this.outcomeName);
          if (!e) return !1;
          const t = yield w.a.getCurrentSession(),
      ...
      static getAttribution(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          if (e.direct && e.direct.enabled) {
            const e = yield w.a.getAll("NotificationClicked");
            if (e.length > 0)
              return {
                type: rt.Direct,
          ...
          if (e.indirect && e.indirect.enabled) {
            ...
            if (
              ...
              const r = o
                ...
                .map((e) => e.notificationId);
              if (
                (r.forEach((e) => w.a.remove("NotificationReceived", e)),
                E.a.debug(
                  `\t${r.length} received notifications will be deleted.`
                ),
                s.length > 0)
              )
                return { type: rt.Indirect, notificationIds: s };
            }
          }
          return e.unattributed && e.unattributed.enabled
            ? { type: rt.Unattributed, notificationIds: [] }
            : { type: rt.NotSupported, notificationIds: [] };
        });
      }
    }
    const pt = () => {
          ...
          () =>
            Object(d.a)(this, void 0, void 0, function* () {
              ...
              try {
                ...
                dt.error("Failed to execute callback", e), s();
              }
            }),
          i
        )),
          (o = () => {
            dt.debug("Cancel called"), self.clearTimeout(n), r || t();
          });
      });
      return o
        ? { promise: s, cancel: o }
        : (dt.warn("clearTimeoutHandle was not assigned."),
          { promise: s, cancel: pt });
    }
    class bt {
      constructor() {
    ...
    class Ot {
      static getPlayer(e, t) {
        return (
          ae.b.enforceAppId(e),
          ae.b.enforcePlayerId(t),
          at.get(`players/${t}?app_id=${e}`)
        );
      }
      static updatePlayer(e, t, i) {
        return (
          ae.b.enforceAppId(e),
          ae.b.enforcePlayerId(t),
          at.put(`players/${t}`, Object.assign({ app_id: e }, i))
        );
      }
      static createUser(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          const t = e.serialize();
          ae.b.enforceAppId(t.app_id);
          const i = yield at.post("players", t);
          return i && i.success ? i.id : null;
        });
      }
      static logoutEmail(e, t, i) {
        return Object(d.a)(this, void 0, void 0, function* () {
          ae.b.enforceAppId(e.appId), ae.b.enforcePlayerId(i);
          const n = yield at.post(`players/${i}/email_logout`, {
            app_id: e.appId,
      ...
      static updateUserSession(e, t) {
        return Object(d.a)(this, void 0, void 0, function* () {
          try {
            const i = t.serialize();
            ae.b.enforceAppId(i.app_id), ae.b.enforcePlayerId(e);
            const n = yield at.post(`players/${e}/on_session`, i);
            return n.id ? n.id : e;
          } catch (e) {
            throw e &&
              Array.isArray(e.errors) &&
              e.errors.length > 0 &&
              ae.b.contains(e.errors[0], "app_id not found")
              ? new ot.a(ot.b.MissingAppId)
              : e;
          }
        });
      }
      static sendOutcome(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          try {
            yield at.post("outcomes/measure", e);
          } catch (e) {
    ...
    class yt {
      static getPlayer(e, t) {
        return Ot.getPlayer(e, t);
      }
      static updatePlayer(e, t, i) {
        return Ot.updatePlayer(e, t, i);
      }
      static jsonpLib(e, t) {
        vt()(e, null, t);
      }
      static downloadServerAppConfig(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          return T.a.getWindowEnv() !== X.a.ServiceWorker
            ? yield new Promise((t, i) => {
                yt.jsonpLib(
                  `${T.a.getOneSignalApiUrl().toString()}/sync/${e}/web`,
                  (e, n) => {
                    e ? i(e) : n.success ? t(n) : i(n);
                  }
                );
              })
            : yield lt.downloadServerAppConfig(e);
        });
      }
      static createUser(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          return yield Ot.createUser(e);
        });
      }
      static logoutEmail(e, t, i) {
        return Object(d.a)(this, void 0, void 0, function* () {
          return yield Ot.logoutEmail(e, t, i);
        });
      }
      static updateUserSession(e, t) {
        return Object(d.a)(this, void 0, void 0, function* () {
          return yield Ot.updateUserSession(e, t);
        });
      }
    }
    class wt {
      ...
      logout() {
        return Object(d.a)(this, void 0, void 0, function* () {
          const e = yield w.a.getEmailProfile();
          if (!e.subscriptionId) return E.a.warn(new b(r.NoEmailSet)), !1;
          const { deviceId: t } = yield w.a.getSubscription();
          if (!t) return E.a.warn(new b(r.NoDeviceId)), !1;
          const i = yield w.a.getAppConfig();
          return (yield yt.logoutEmail(i, e, t))
            ? (yield w.a.setEmailProfile(new ft.a()), !0)
      ...
      updatePushPlayersRelationToEmailPlayer(e, t) {
        return Object(d.a)(this, void 0, void 0, function* () {
          const { deviceId: i } = yield w.a.getSubscription(),
            n = i,
    ...
    class Et {
      static addExternalUserIdToDeviceRecord(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          const t = yield w.a.getExternalUserId();
          if (!t) return;
          e.externalUserId = t;
          const i = yield w.a.getExternalUserIdAuthHash();
      ...
      setIdentifier(e, t) {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          if (n.subscriptionId)
            ...
            const { deviceId: e } = yield w.a.getSubscription(),
              t = new It(
      ...
      sendTags(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          const t = yield this.profileProvider.getSubscriptionId(),
            { appId: i } = yield w.a.getAppConfig(),
      ...
      setExternalUserId(e, t) {
        return Object(d.a)(this, void 0, void 0, function* () {
          const i = yield this.profileProvider.getSubscriptionId(),
            { appId: n } = yield w.a.getAppConfig(),
            o = { external_user_id: e, external_user_id_auth_hash: t };
          yield Ot.updatePlayer(n, i, o);
        });
      }
    }
    class At {
      ...
      sendOnFocus(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          const i = {
            app_id: (yield w.a.getAppConfig()).appId,
            type: 1,
            state: "ping",
            active_time: e,
            device_type: this.profileProvider.deviceType,
          };
          yield at.post(`players/${t.subscriptionId}/on_focus`, i);
        });
      }
    }
    class Mt {
      ...
      sendOnSession() {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          const t = new It(
            ...
            i = yield w.a.getAppConfig();
          t.appId = i.appId;
          const n = yield Ot.updateUserSession(e.subscriptionId, t);
          n !== e.subscriptionId &&
    ...
    class xt extends Nt {
      constructor() {
        super(...arguments), (this.deviceType = Z.Email);
      }
      newProfile(e, t, i) {
        return new ft.a(e, t, i);
      }
      getProfile() {
        return Object(d.a)(this, void 0, void 0, function* () {
          return yield w.a.getEmailProfile();
        });
      }
      setProfile(e) {
        ...
        return Object(d.a)(this, void 0, void 0, function* () {
          yield w.a.setEmailProfile(e), yield t.setProfile.call(this, e);
        });
      }
    }
    var kt,
    ...
    class Ut extends Nt {
      constructor() {
        super(...arguments), (this.deviceType = Z.SMS);
      }
      newProfile(e, t, i) {
      ...
      getProfile() {
        return Object(d.a)(this, void 0, void 0, function* () {
          return yield w.a.getSMSProfile();
        });
      }
      setProfile(e) {
        const t = Object.create(null, {
        ...
        return Object(d.a)(this, void 0, void 0, function* () {
          yield w.a.setSMSProfile(e), yield t.setProfile.call(this, e);
        });
      }
    }
    class Wt {
      ...
      logout() {
        return Object(d.a)(this, void 0, void 0, function* () {
          return (yield w.a.getSMSProfile()).subscriptionId
            ? (yield w.a.setSMSProfile(new Rt.a()), !0)
    ...
    class Lt {
      ...
      static appendServiceWorkerParams(e, t, i) {
        return `${
          new URL(e, I.a.getBaseUrl()).href
        }?${ae.b.encodeHashAsUriComponent({
          appId: t,
        })}&${ae.b.encodeHashAsUriComponent({ sdkVersion: i })}`;
      }
      static upsertSession(e, t, i, n, o, s) {
        return Object(d.a)(this, void 0, void 0, function* () {
          if (!n) return void dt.error("No deviceId provided for new session.");
          if (!i.app_id)
            return void dt.error("No appId provided for new session.");
          const r = yield w.a.getCurrentSession();
          if (!r) {
            const e = i.app_id,
              t = Object(ue.d)({
                deviceId: n,
              ...
              s = yield w.a.getLastNotificationClicked(e);
            return (
              s && (t.notificationId = s.notificationId),
              yield w.a.upsertSession(t),
              void (yield Lt.sendOnSessionCallIfNecessary(o, i, n, t))
            );
          }
          if (r.status === ue.c.Active)
            return void dt.debug("Session already active", r);
          if (!r.lastDeactivatedTimestamp)
            return void dt.debug("Session is in invalid state", r);
          ...
          yield w.a.upsertSession(c),
            yield Lt.sendOnSessionCallIfNecessary(o, i, n, c);
        });
      }
      static deactivateSession(e, t, i) {
        return Object(d.a)(this, void 0, void 0, function* () {
          const n = yield w.a.getCurrentSession();
          if (!n)
            return void dt.debug("No active session found. Cannot deactivate.");
          if (n.status === ue.c.Inactive)
            return mt(() => Lt.finalizeSession(n, t, i), e);
          if (n.status !== ue.c.Active)
            return void dt.warn(
          ...
          (n.lastDeactivatedTimestamp = o),
            ...
            (n.status = ue.c.Inactive);
          const r = mt(() => Lt.finalizeSession(n, t, i), e);
          return yield w.a.upsertSession(n), r;
        });
      }
      static sendOnSessionCallIfNecessary(e, t, i, n) {
        return Object(d.a)(this, void 0, void 0, function* () {
          if (e === ue.b.PlayerCreate) return;
          if (!t.identifier) {
            const e = yield self.registration.pushManager.getSubscription();
            if (e) {
              const i = le.setFromW3cSubscription(e),
                n = new ne(i).serialize();
              t.identifier = n.identifier;
            }
          }
          const o = yield ct.updateUserSession(i, t);
          o !== i &&
            ((n.deviceId = o),
            yield Promise.all([
              w.a.setDeviceId(o),
              w.a.upsertSession(n),
              w.a.resetSentUniqueOutcomes(),
            ])),
      ...
      static finalizeSession(e, t, i) {
        return Object(d.a)(this, void 0, void 0, function* () {
          if (
            ...
            const t = yield ht.getAttribution(i);
            dt.debug("send on_focus with attribution", t),
              yield ct.sendSessionDuration(
                e.appId,
                e.deviceId,
          ...
          yield Promise.all([
            w.a.cleanupCurrentSession(),
            w.a.removeAllNotificationClicked(),
          ]),
            dt.debug(
    ...
    class Vt {
      ...
      getRegistration() {
        return Object(d.a)(this, void 0, void 0, function* () {
          return yield ve.getRegistration(
      ...
      getActiveState() {
        return Object(d.a)(this, void 0, void 0, function* () {
          const e = yield T.a.getIntegration();
          if (e === Ce.a.InsecureProxy) return kt.Indeterminate;
          if (e === Ce.a.SecureProxy) {
            switch (T.a.getWindowEnv()) {
              case X.a.Host:
              case X.a.CustomIframe:
      ...
      static activeSwFileName(e) {
        const t = ve.getAvailableServiceWorker(e);
        if (!t) return null;
        const i = new URL(t.scriptURL).pathname,
          n = new tt(i).getFileName();
        if ("akam-sw.js" == n) {
          ...
          if (e)
            return (
              ...
              new tt(new URL(e).pathname).getFileName()
            );
        }
        return n;
      }
          ...
          return new Promise((e) =>
            Object(d.a)(this, void 0, void 0, function* () {
              if (I.b.isUsingSubscriptionWorkaround()) {
                ...
                this.context.workerMessenger.once(pe.WorkerVersion, (t) => {
                  e(t);
                }),
                  yield this.context.workerMessenger.unicast(pe.WorkerVersion);
            })
          );
        });
      }
      ...
      haveParamsChanged() {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          const n = ve.getAvailableServiceWorker(e),
      ...
      workerNeedsUpdate() {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          try {
            e = yield ae.a.timeoutPromise(this.getWorkerVersion(), 2e3);
          } catch (e) {
            return (
              E.a.info(
      ...
      establishServiceWorkerChannel() {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          e.off(),
            e.on(pe.NotificationDisplayed, (e) =>
              Object(d.a)(this, void 0, void 0, function* () {
                E.a.debug(
                  location.origin,
            ...
            e.on(pe.NotificationClicked, (e) =>
              Object(d.a)(this, void 0, void 0, function* () {
                let t;
                if (
                  0 ===
                  (t =
                    T.a.getWindowEnv() === X.a.OneSignalProxyFrame
                      ? yield new Promise((e) => {
                  ...
                  e.url || (t = location.href),
                    yield w.a.put("NotificationOpened", {
                      url: t,
                      data: e,
                      timestamp: Date.now(),
                    });
            ...
            e.on(pe.NotificationDismissed, (e) =>
              Object(d.a)(this, void 0, void 0, function* () {
          ...
          e.on(pe.AreYouVisible, (n) =>
            Object(d.a)(this, void 0, void 0, function* () {
              if (t && i) {
                ...
                yield e.directPostMessageToSW(pe.AreYouVisibleResponse, t);
              } else {
      ...
      installWorker() {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          const e = Lt.getServiceWorkerHref(
            ...
            t = `${I.b.getBaseUrl()}${this.config.registrationOptions.scope}`;
          E.a.info(
          ...
          try {
            ...
            if (403 === i.status || 404 === i.status)
              throw new nt(i.status, i.statusText);
            throw t;
          }
      ...
      constructor(e) {
        ...
        switch (e) {
          case _t.InvalidSafariSetup:
            t =
              "The Safari Sika ANIME URL, icon size, or push certificate is invalid, or Safari is in a private session.";
            break;
          case _t.Blocked:
            t = "Notification permissions are blocked.";
            break;
    ...
    class Ht {
      ...
      subscribe(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          const t = T.a.getWindowEnv();
          switch (t) {
            case X.a.CustomIframe:
            case X.a.Unknown:
            case X.a.OneSignalProxyFrame:
              throw new m(o.UnsupportedEnvironment);
          }
          let i;
          switch (t) {
            case X.a.ServiceWorker:
      ...
      registerSubscription(e, t) {
        return Object(d.a)(this, void 0, void 0, function* () {
          e && (e = le.deserialize(e));
          const i = ne.createFromPushSubscription(this.config.appId, e, t);
          let n = void 0;
          ...
          const o = yield w.a.getSubscription();
          return (
            (o.deviceId = n),
            (o.optedOut = !1),
            e
      ...
      unsubscribe(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          if (0 === e) throw new te();
          if (1 !== e) throw new te();
          if (T.a.getWindowEnv() !== X.a.ServiceWorker) throw new te();
          {
            const { deviceId: e } = yield w.a.getSubscription();
            yield Ot.updatePlayer(this.context.appConfig.appId, e, {
              notification_types: Q.MutedByApi,
            }),
              yield w.a.put("Options", { key: "optedOut", value: !0 });
          }
        });
      }
      ...
      associateSubscriptionWithEmail(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          const t = yield w.a.getEmailProfile();
          t.subscriptionId &&
            (yield Ot.updatePlayer(this.config.appId, e, {
              parent_player_id: t.subscriptionId,
              email: t.identifier,
            }));
        });
      ...
      subscribeSafariPromptPermission() {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          return this.safariPermissionPromptFailed
            ? e(`${T.a.getOneSignalApiUrl().toString()}/safari`)
            : e(
                `${T.a.getOneSignalApiUrl().toString()}/safari/apps/${
                  this.config.appId
                }`
              );
        });
      ...
      subscribeSafari() {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          if ((re.a.triggerNotificationPermissionChanged(), !i))
            throw (
              ...
              (e instanceof nt &&
                (403 === e.status
                  ? yield this.context.subscriptionManager.registerFailedSubscription(
                      Q.ServiceWorkerStatus403,
                      this.context
                    )
                  : 404 === e.status &&
                    (yield this.context.subscriptionManager.registerFailedSubscription(
                      Q.ServiceWorkerStatus404,
                      this.context
                    ))),
              e)
            );
      ...
      subscribeFcmFromWorker(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          if ("denied" === i) throw new ce(oe.Blocked);
          if ("prompt" === i) throw new ce(oe.Default);
      ...
      subscribeWithVapidKey(e, t) {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          const s = le.setFromW3cSubscription(n);
          return (
            i && (s.existingW3cPushSubscription = le.setFromW3cSubscription(i)),
            s
          );
        });
      }
      static updateSubscriptionTime(e, t) {
        return Object(d.a)(this, void 0, void 0, function* () {
          const i = yield w.a.getSubscription();
          e && (i.createdAt = new Date().getTime()),
            (i.expirationTime = t),
            yield w.a.setSubscription(i);
        });
      }
        ...
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          switch (e) {
            ...
            case Ce.a.SecureProxy:
              ...
              return yield this.isSubscriptionExpiringForSecureIntegration();
            case Ce.a.InsecureProxy:
              const { expirationTime: i } = yield w.a.getSubscription();
      ...
      isSubscriptionExpiringForSecureIntegration() {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          let { createdAt: i } = yield w.a.getSubscription();
          if (!i) {
            const e = 31536e6;
      ...
      getSubscriptionState() {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          const e = T.a.getWindowEnv();
          switch (e) {
            case X.a.ServiceWorker:
              const t = yield self.registration.pushManager.getSubscription(),
                { optedOut: i } = yield w.a.getSubscription();
              return { subscribed: !!t, optedOut: !!i };
            default:
              switch (yield T.a.getIntegration()) {
                case Ce.a.Secure:
                  return this.getSubscriptionStateForSecure();
                case Ce.a.SecureProxy:
                  switch (e) {
      ...
      getSubscriptionStateForSecure() {
        return Object(d.a)(this, void 0, void 0, function* () {
          const { deviceId: e, optedOut: t } = yield w.a.getSubscription();
          if (h.a.useSafariLegacyPush()) {
          ...
          return n
            ? { subscribed: !(!e || o !== y.Granted || !s), optedOut: !!t }
    ...
    var $t = class {
      static getServiceWorkerManager(e) {
        const t = e.appConfig,
          i = T.a.getBuildEnvPrefix(),
          n = {
            workerPath: new tt(`/${i}OneSignalSDKWorker.js`),
    ...
    class Gt {
      ...
      isDeviceIdAvailable() {
        return Object(d.a)(this, void 0, void 0, function* () {
          return null != (yield w.a.getSubscription()).deviceId;
        });
      }
      getDeviceId() {
        return Object(d.a)(this, void 0, void 0, function* () {
      ...
      createDeviceRecord() {
        return Object(d.a)(this, void 0, void 0, function* () {
          return he.createDeviceRecord(this.context.appConfig.appId);
        });
      }
      sendPushDeviceRecordUpdate(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          e || (e = yield this.createDeviceRecord()),
            this.onSessionSent
              ? yield Ot.updatePlayer(
                  this.context.appConfig.appId,
                  t,
                  Object.assign(
                    { notification_types: Q.Subscribed },
                    e.serialize()
                  )
                )
      ...
      sendOnSessionUpdate(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          if (
            (e || (e = yield this.createDeviceRecord()),
            e.subscriptionState === Q.Subscribed ||
      ...
      sendExternalUserIdUpdate(e, t) {
        return Object(d.a)(this, void 0, void 0, function* () {
          t || (t = yield w.a.getExternalUserIdAuthHash());
          const i = {
            external_user_id: ae.b.getValueOrDefault(e, ""),
            external_user_id_auth_hash: ae.b.getValueOrDefault(t, void 0),
          };
      ...
      sendTagsUpdate(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          const t = { tags: e },
            i = yield w.a.getExternalUserIdAuthHash();
      ...
      sendPushPlayerUpdate(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          let { deviceId: t } = yield w.a.getSubscription();
          if (
            (t ||
              (yield Object(K.d)(OneSignal.EVENTS.REGISTERED),
              ({ deviceId: t } = yield w.a.getSubscription())),
            t)
          )
            return yield Ot.updatePlayer(this.context.appConfig.appId, t, e);
        });
      }
      sendOutcomeDirect(e, t, i, n) {
        return Object(d.a)(this, void 0, void 0, function* () {
          Object(K.s)("sendOutcomeDirect");
          ...
          void 0 !== n && (s.weight = n), yield Ot.sendOutcome(s);
        });
      }
      sendOutcomeInfluenced(e, t, i, n) {
        return Object(d.a)(this, void 0, void 0, function* () {
          Object(K.s)("sendOutcomeInfluenced");
          const o = yield this.createDeviceRecord(),
            s = {
              app_id: e,
              id: i,
    ...
    class ti {
      ...
      generateHtml() {
        ...
        let t, i, n;
        switch (
          (Object(K.a)(e, $.channelCaptureContainer),
          (e.id = $.channelCaptureContainer),
          this.promptOptions.type)
        ) {
          case O.Sms:
            (t = this.promptOptions.text.smsLabel || "Phone Number"),
              (i = this.getInputWithValidationElement(O.Sms, t)),
              e.appendChild(i);
            break;
          case O.Email:
            (t = this.promptOptions.text.emailLabel || "Email"),
              (n = this.getInputWithValidationElement(O.Email, t)),
              e.appendChild(n);
            break;
          case O.SmsAndEmail:
            (t = this.promptOptions.text.emailLabel || "Email"),
      ...
      getInputWithValidationElement(e, t) {
        ...
        return (
          ...
          Object(K.a)(a, $.onesignalValidationElementHidden),
          Object(K.a)(a, $.onesignalValidationElement),
          ...
          Object(K.a)(o, i.inputClass),
          Object(K.a)(c, $.inputWithValidationElement),
      ...
      getTypeSpecificVariablesForValidationElemGeneration(e) {
        if (e === O.Email)
          return {
            ...
            validationElementId: G.onesignalEmailValidationElement,
            inputElementId: G.onesignalEmailInput,
            inputClass: $.onesignalEmailInput,
            wrappingDivId: G.emailInputWithValidationElement,
            tabIndex: 1,
          };
        if (e === O.Sms)
          return {
            ...
            domElementType: "tel",
            validationElementId: G.onesignalSmsValidationElement,
            inputElementId: G.onesignalSmsInput,
            inputClass: $.onesignalSmsInput,
            wrappingDivId: G.smsInputWithValidationElement,
            tabIndex: 2,
          };
        throw new Error("invalid channel type for input validation");
      }
      initializePhoneInputLibrary() {
        const e = Object(K.l)(`#${G.onesignalSmsInput}`);
      ...
      addSmsInputEventListeners() {
        ...
        e.addEventListener("keyup", (t) => {
          ...
          (this.smsInputFieldIsValid =
            ...
            "Enter" === t.key &&
              (null === (n = document.getElementById(R.allowButton)) ||
                void 0 === n ||
                n.click()),
      ...
      addEmailInputEventListeners() {
        const e = Object(K.l)(`#${G.onesignalEmailInput}`);
        e.addEventListener("keyup", (t) => {
          var i, n;
      ...
      updateValidationOnSmsInputChange() {
        const e = Object(K.l)(`#${G.smsInputWithValidationElement}`),
          t = Object(K.l)(`#${G.onesignalSmsValidationElement}`);
        Object(K.v)(e, $.onesignalErrorInput),
          Object(K.a)(t, $.onesignalValidationElementHidden);
      }
      updateValidationOnEmailInputChange() {
        const e = Object(K.l)(`#${G.emailInputWithValidationElement}`),
          t = Object(K.l)(`#${G.onesignalEmailValidationElement}`);
        Object(K.v)(e, $.onesignalErrorInput),
          Object(K.a)(t, $.onesignalValidationElementHidden);
      }
      ...
      mount() {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          Object(K.l)(`#${R.body}`).appendChild(i),
            e &&
      ...
      getValueFromEmailInput() {
        var e;
        return (
          (null === (e = Object(K.l)(`#${G.onesignalEmailInput}`)) ||
          void 0 === e
            ? void 0
            : e.value) || ""
        );
      ...
      static showSmsInputError(e) {
        const t = document.querySelector(`#${G.onesignalSmsValidationElement}`),
          i = document.querySelector(`#${G.smsInputWithValidationElement}`);
        t && i
          ? e
            ? (t.classList.remove($.onesignalValidationElementHidden),
              i.classList.add($.onesignalErrorInput))
            : (t.classList.add($.onesignalValidationElementHidden),
              i.classList.remove($.onesignalErrorInput))
          : E.a.error("OneSignal: couldn't find slidedown validation element");
      }
      static showEmailInputError(e) {
        const t = document.querySelector(
            `#${G.onesignalEmailValidationElement}`
          ),
          i = document.querySelector(`#${G.emailInputWithValidationElement}`);
        t && i
          ? e
            ? (t.classList.remove($.onesignalValidationElementHidden),
              i.classList.add($.onesignalErrorInput))
      ...
      static isUsingSmsInputField(e) {
        return e === O.Sms || e === O.SmsAndEmail;
      }
      static isUsingEmailInputField(e) {
        return e === O.Email || e === O.SmsAndEmail;
      }
    }
    ...
    class ni {
        ...
        switch (
          ...
          case O.Category:
            (this.negativeUpdateButton =
              ...
              (this.errorButton = ae.a.getValueOrDefault(
      ...
      create(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          if (null === this.notificationIcons) {
            const t = yield he.getNotificationIcons();
            (this.notificationIcons = t),
              this.container.className.includes(j.container) &&
                Object(K.w)(`#${R.container}`);
            const i =
              ...
              o = (function (e) {
                const {
                  ...
                  s = t === j.defaultIcon ? L : t,
                  r = t === j.defaultIcon ? j.defaultIcon : "",
                ...
                return (
                  Object(K.a)(c, j.body),
                  Object(K.a)(d, j.icon),
                  Object(K.a)(l, j.message),
                  Object(K.a)(g, j.footer),
                  Object(K.a)(m, j.clearfix),
                  Object(K.a)(b, j.clearfix),
                  Object(K.a)(h, U.alignRight),
                  Object(K.a)(h, U.primary),
                  Object(K.a)(h, U.slidedownButton),
                  Object(K.a)(p, U.alignRight),
                  Object(K.a)(p, U.secondary),
                  Object(K.a)(p, U.slidedownButton),
                  (a.id = R.normalSlidedown),
                  (c.id = R.body),
                  (u.id = R.loadingContainer),
                  (h.id = R.allowButton),
                  (p.id = R.cancelButton),
                  (g.id = R.footer),
                  r && Object(K.a)(f, r),
              ...
              r = document.createElement("div");
            (s.id = R.container),
              Object(K.a)(s, j.container),
              Object(K.a)(s, j.reset),
              Object(K.l)("body").appendChild(s),
              (r.id = R.dialog),
              Object(K.a)(r, j.dialog),
              r.appendChild(o),
              this.container.appendChild(r),
              Object(K.a)(this.container, g.a.mobile ? j.slideUp : j.slideDown),
      ...
      close() {
        Object(K.a)(this.container, j.closeSlidedown),
          Object(K.u)(
            this.dialog,
            "animationend",
            (e, t) => {
      ...
      setSaveState() {
        (this.allowButton.disabled = !0),
          ...
          Object(K.b)(
            ...
            "beforeend",
            Jt(F.whiteLoadingIndicator)
          ),
          Object(K.a)(this.allowButton, "disabled"),
          Object(K.a)(this.allowButton, j.savingStateButton);
      }
      removeSaveState() {
        (this.allowButton.textContent = this.positiveUpdateButton),
          Object(K.w)(`#${j.buttonIndicatorHolder}`),
          (this.allowButton.disabled = !1),
          Object(K.v)(this.allowButton, "disabled"),
          Object(K.v)(this.allowButton, j.savingStateButton);
      }
      setFailureState() {
        (this.allowButton.textContent = null),
          this.allowButton.insertAdjacentElement(
          ...
          this.options.type === O.Category &&
            ...
            Object(K.a)(this.allowButton, "onesignal-error-state-button")),
      ...
      removeFailureState() {
        Object(K.w)("#onesignal-button-indicator-holder"),
          Object(K.v)(this.allowButton, "onesignal-error-state-button"),
          C.isSlidedownPushDependent(this.options.type) ||
            ti.resetInputErrorStates(this.options.type),
          (this.isShowingFailureState = !1);
      }
      getPlatformNotificationIcon() {
        return Object(K.m)(this.notificationIcons);
      }
      getIndicatorHolder() {
        const e = document.createElement("div");
        return (
          (e.id = R.buttonIndicatorHolder),
          Object(K.a)(e, j.buttonIndicatorHolder),
          e
        );
      }
      getTextSpan(e) {
      ...
      get container() {
        return Object(K.l)(`#${R.container}`);
      }
      get dialog() {
        return Object(K.l)(`#${R.dialog}`);
      }
      get allowButton() {
        return Object(K.l)(`#${R.allowButton}`);
      }
      get cancelButton() {
        return Object(K.l)(`#${R.cancelButton}`);
      }
      get buttonIndicatorHolder() {
        return Object(K.l)(`#${R.buttonIndicatorHolder}`);
      }
      get slidedownFooter() {
        return Object(K.l)(`#${R.footer}`);
      }
      static get EVENTS() {
        return {
    ...
    class di {
      ...
      static getBrowserVersion() {
        return ae.b.parseVersionString(g.a.version);
      }
      static isHttps() {
        return (
    ...
    class gi {
      ...
      spawnAutoPrompts() {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          const i = OneSignal.config.userConfig.promptOptions,
            ...
            o = this.getDelayedPromptOptions(i, O.Native),
          ...
          const c = !!C.getFirstSlidedownPromptOptionsWithType(
            null === (e = i.slidedown) || void 0 === e ? void 0 : e.prompts,
            O.Push
          );
          a && !c && this.internalShowDelayedPrompt(O.Push, o.timeDelay || 0);
          const l =
      ...
      internalShowDelayedPrompt(e, t, i) {
        return Object(d.a)(this, void 0, void 0, function* () {
          if (
            (I.b.logMethodCall("internalShowDelayedPrompt"),
            "number" != typeof t)
          )
            return void E.a.error(
      ...
      internalShowNativePrompt() {
        return Object(d.a)(this, void 0, void 0, function* () {
          I.b.logMethodCall("internalShowNativePrompt"),
            this.isNativePromptShowing
              ? E.a.debug(
                  "Already showing autoprompt. Abort showing a native prompt."
                )
              : ((this.isNativePromptShowing = !0),
                he.markHttpSlidedownShown(),
                yield Xe.registerForPushNotifications(),
                (this.isNativePromptShowing = !1),
                We.markPromptDismissedWithType(Ee.Push));
        });
      }
      internalShowSlidedownPrompt(e = { force: !1 }) {
        return Object(d.a)(this, void 0, void 0, function* () {
          I.b.logMethodCall("internalShowSlidedownPrompt"),
      ...
      internalShowCategorySlidedown(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          I.b.logMethodCall("internalShowCategorySlidedown"),
            yield this.internalShowParticularSlidedown(O.Category, e);
        });
      }
      internalShowSmsSlidedown(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          I.b.logMethodCall("internalShowSmsSlidedown"),
            yield this.internalShowParticularSlidedown(O.Sms, e);
        });
      }
      internalShowEmailSlidedown(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          I.b.logMethodCall("internalShowEmailSlidedown"),
            yield this.internalShowParticularSlidedown(O.Email, e);
        });
      }
      internalShowSmsAndEmailSlidedown(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          I.b.logMethodCall("internalShowSmsAndEmailSlidedown"),
            yield this.internalShowParticularSlidedown(O.SmsAndEmail, e);
        });
      }
        ...
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          const o =
            ...
            s =
              ...
              C.getFirstSlidedownPromptOptionsWithType(o, e);
          if (!s) {
            if (e !== O.Push)
              return void E.a.error(
            ...
            switch (e) {
              ...
              default:
                E.a.debug(
                  ...
                  We.markPromptDismissedWithType(Ee.NonPush);
            }
          });
      }
        ...
        switch (t) {
          ...
          case O.SmsAndEmail:
            const { userConfig: c } = this.context.appConfig,
              l = C.getFirstSlidedownPromptOptionsWithType(
                (null ===
                  (n =
    ...
    class hi {
        ...
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          !this.context.environmentInfo.isUsingSubscriptionWorkaround
            ? (E.a.debug("Notify SW to upsert session"),
              yield this.context.workerMessenger.unicast(pe.SessionUpsert, o))
        ...
        return Object(d.a)(this, void 0, void 0, function* () {
          const e = document.visibilityState,
            [t, i] = yield Promise.all([
              he.getDeviceId(),
              he.createDeviceRecord(this.context.appConfig.appId, !0),
            ]);
          if ("visible" === e)
            return (
          ...
          if ("hidden" !== e)
            ...
            const [e, t] = yield Promise.all([
              he.getDeviceId(),
              he.createDeviceRecord(this.context.appConfig.appId),
            ]);
            yield this.notifySWToDeactivateSession(e, t, ue.b.VisibilityHidden);
          }
        });
      }
        ...
        return Object(d.a)(this, void 0, void 0, function* () {
          const e = I.a.isHttps(),
            t = {
              ...
              enableSessionDuration:
                this.context.appConfig.enableSessionDuration,
              sessionOrigin: ue.b.BeforeUnload,
              isHttps: e,
              isSafari: I.a.isSafari(),
              outcomesConfig: this.context.appConfig.userConfig.outcomes,
            };
      ...
      handleOnFocus(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          yield this.notifySWToUpsertSession(t, i, ue.b.Focus);
        });
      }
      handleOnBlur(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          yield this.notifySWToDeactivateSession(t, i, ue.b.Blur);
        });
      }
      upsertSession(e, t, i) {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          this.context.environmentInfo.isUsingSubscriptionWorkaround
            ? this.context.environmentInfo.canTalkToServiceWorker
              ...
              : ((this.onSessionSent = i === ue.b.PlayerCreate),
      ...
      sendOnSessionUpdateFromPage(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          const t = yield he.getDeviceId();
          if (
            (e ||
              (e = yield he.createDeviceRecord(this.context.appConfig.appId)),
            e.subscriptionState === Q.Subscribed ||
              !0 === OneSignal.config.enableOnSession)
          ) {
            try {
              const i = yield Ot.updateUserSession(t, e);
              if (((this.onSessionSent = !0), i !== t)) {
                const e = yield w.a.getSubscription();
                (e.deviceId = i), yield w.a.setSubscription(e);
              }
            } catch (e) {
              E.a.error(
                `Failed to update user session. Error "${e.message}" ${e.stack}`
    ...
    class bi {
      mount(e, t) {
        ...
        const n = Object(K.l)(`#${R.allowButton}`);
        (n.disabled = !1),
          Object(K.v)(n, "disabled"),
          Object(K.w)(`#${R.loadingContainer}`);
      }
      load() {
        const e = Object(K.l)(`#${R.loadingContainer}`),
          t = Object(K.l)(`#${R.allowButton}`),
          i = document.createElement("div");
        Object(K.a)(e, `${j.loadingContainer}`),
          Object(K.a)(i, W.loadingMessage),
          Object(K.a)(t, "disabled"),
          Object(K.b)(e, "beforeend", Jt(F.greyLoadingIndicator)),
          (i.innerText = H.fetchingPreferences),
          e.appendChild(i),
          (t.disabled = !0);
      }
      generateHtml(e, t) {
        const i = pi.getCheckedTagCategories(e, t),
          ...
          a = document.createElement("div");
        return (
          Object(K.a)(s, W.taggingContainerCol),
          Object(K.a)(r, W.taggingContainerCol),
          Object(K.a)(a, W.taggingContainer),
          (a.id = B.taggingContainer),
          n.forEach((e) => {
      ...
      getCategoryLabelElement(e) {
        const { label: t } = e,
          ...
          a = document.createElement("div");
        return (
          Object(K.a)(i, W.categoryLabel),
          Object(K.a)(n, W.categoryLabelText),
          Object(K.a)(o, W.categoryLabelInput),
          Object(K.a)(s, W.checkmark),
          (i.title = t),
          (n.innerText = t),
          (o.type = "checkbox"),
          (o.value = e.tag),
      ...
      get taggingContainer() {
        const e = `#${R.body} > div.${W.taggingContainer}`;
        return Object(K.l)(e);
      }
      toggleCheckedTag(e) {
        const t = e.target;
    ...
    class Si {
      ...
      show() {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          (i.id = R.container),
            (e.id = D.toastText),
            Object(K.a)(e, _.toastText),
            Object(K.a)(i, j.container),
            Object(K.a)(i, j.reset),
            Object(K.l)("body").appendChild(i),
            (n.id = R.dialog),
            Object(K.a)(n, j.dialog),
            n.appendChild(e),
    ...
    class yi {
      ...
      checkIfSlidedownShouldBeShown(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          var t;
          const i =
              (yield OneSignal.privateGetNotificationPermission()) === y.Denied,
          ...
          const a =
            null === (t = e.slidedownPromptOptions) || void 0 === t
              ...
              : t.type;
          let c = !1;
          if ((a && (c = C.isSlidedownPushDependent(a)), c)) {
            if (n) return !!e.isInUpdateMode || (E.a.info(new vi()), !1);
            if (((s = We.wasPromptOfTypeDismissed(Ee.Push)), !o))
              throw new b(r.OptedOut);
            if (i) return E.a.info(new ce(oe.Blocked)), !1;
          } else {
            if (!e.force) {
              const e = !!(yield w.a.getSMSProfile()).subscriptionId,
                t = !!(yield w.a.getEmailProfile()).subscriptionId,
                i = e && t;
              if (e && a === O.Sms) return E.a.info(new Oi(O.Sms)), !1;
              if (t && a === O.Email) return E.a.info(new Oi(O.Email)), !1;
              if (i && a === O.SmsAndEmail)
                return E.a.info(new Oi(O.SmsAndEmail)), !1;
            }
            s = We.wasPromptOfTypeDismissed(Ee.NonPush);
          }
          return (
      ...
      mountTaggingContainer(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          var t;
          I.a.logMethodCall("mountTaggingContainer");
          try {
            let i = {};
            const n = new bi(),
              o =
      ...
      mountChannelCaptureContainer(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          I.a.logMethodCall("mountChannelCaptureContainer");
          try {
      ...
      createSlidedown(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          I.a.logMethodCall("createSlidedown");
          try {
    ...
    class wi {
      constructor(e) {
        (this.appConfig = e),
          ...
          (this.pageViewManager = new et()),
          (this.permissionManager = new A()),
          (this.workerMessenger = new ye(this)),
          ...
          (this.dynamicResourceLoader = new we()),
          (this.metricsManager = new Qe(
            e.metrics.enable,
    ...
    class Ei {
      ...
      static convertConfigToVersionTwo(e) {
        var t, i, n, o;
        const s = C.isCategorySlidedownConfiguredVersion1(e)
          ? O.Category
          : O.Push;
        let r, a;
        return (
    ...
    class Pi {
      static getAppConfig(e, t) {
        return Object(d.a)(this, void 0, void 0, function* () {
          try {
            if (!e || !e.appId || !I.b.isValidUuid(e.appId))
      ...
      static checkRestrictedOrigin(e) {
        if (
          ...
          T.a.getWindowEnv() !== X.a.ServiceWorker &&
          window.top === window &&
          !ae.b.contains(window.location.hostname, ".os.tc") &&
          !ae.b.contains(window.location.hostname, ".onesignal.com") &&
          !this.doesCurrentOriginMatchConfigOrigin(e.origin)
        )
          throw new f(c.WrongSika ANIMEUrl, { Sika ANIMEUrl: e.origin });
      }
      ...
      static getMergedConfig(e, t) {
        const i = this.getConfigIntegrationKind(t),
          ...
          s = I.b.internalIsUsingSubscriptionWorkaround(n, o),
          r = this.getUserConfigForConfigIntegrationKind(i, e, t, s);
        return {
          appId: t.app_id,
          subdomain: n,
          Sika ANIMEName: t.config.Sika ANIMEInfo.name,
          ...
          userConfig: r,
          enableOnSession: ae.b.valueOrDefault(
            t.features.enable_on_session,
            zt.enableOnSessionForUnsubcribed
          ),
          sessionThreshold: ae.b.valueOrDefault(
            t.features.session_threshold,
            zt.reportingThreshold
          ),
          enableSessionDuration: ae.b.valueOrDefault(
      ...
      static injectDefaultsIntoPromptOptions(e, t, i, n = !1) {
        ...
        const a = t.customlink,
          c = Object.assign(Object.assign({}, e), {
            customlink: {
              enabled: ae.b.getValueOrDefault(r.enabled, a.enabled),
              style: ae.b.getValueOrDefault(r.style, a.style),
              size: ae.b.getValueOrDefault(r.size, a.size),
              unsubscribeEnabled: ae.b.getValueOrDefault(
                r.unsubscribeEnabled,
                a.unsubscribeEnabled
              ),
              text: {
                subscribe: ae.b.getValueOrDefault(
                  r.text ? r.text.subscribe : void 0,
                  a.text.subscribe
                ),
                unsubscribe: ae.b.getValueOrDefault(
                  r.text ? r.text.unsubscribe : void 0,
                  a.text.unsubscribe
                ),
                explanation: ae.b.getValueOrDefault(
                  r.text ? r.text.explanation : void 0,
                  a.text.explanation
                ),
              },
              color: {
                button: ae.b.getValueOrDefault(
                  r.color ? r.color.button : void 0,
                  a.color.button
                ),
                text: ae.b.getValueOrDefault(
        ...
        if (
            ...
            ? (c.slidedown.prompts =
                null ===
                  ...
                  : s.map((e) => {
                      ...
                      if (
                        ((e.type = ae.b.getValueOrDefault(e.type, O.Push)),
                        e.type === O.Category &&
                          (e.text = Object.assign(Object.assign({}, e.text), {
                            positiveUpdateButton: ae.b.getValueOrDefault(
                              null === (t = e.text) || void 0 === t
                                ? void 0
                                : t.positiveUpdateButton,
                              Kt.categoryDefaults.positiveUpdateButton
                            ),
                            negativeUpdateButton: ae.b.getValueOrDefault(
                              null === (i = e.text) || void 0 === i
                                ? void 0
                                : i.negativeUpdateButton,
                              Kt.categoryDefaults.negativeUpdateButton
                            ),
                            updateMessage: ae.b.getValueOrDefault(
                        ...
                        (e.text = Object.assign(Object.assign({}, e.text), {
                          actionMessage: ae.b.getValueOrDefault(
                            null === (o = e.text) || void 0 === o
                              ? void 0
                              : o.actionMessage,
                            Kt.actionMessage
                          ),
                          acceptButton: ae.b.getValueOrDefault(
                            null === (s = e.text) || void 0 === s
                              ? void 0
                              : s.acceptButton,
                            Kt.acceptButton
                          ),
                          cancelButton: ae.b.getValueOrDefault(
                            null === (r = e.text) || void 0 === r
                              ? void 0
                              : r.cancelButton,
                            Kt.cancelButton
                          ),
                          confirmMessage: ae.b.getValueOrDefault(
                        ...
                        (e.autoPrompt = ae.b.getValueOrDefault(
                          e.autoPrompt,
                          !0
                        )),
                        (e.delay = {
                          pageViews: ae.b.getValueOrDefault(
                            null === (c = e.delay) || void 0 === c
                              ? void 0
                              : c.pageViews,
                            qt.pageViews
                          ),
                          timeDelay: ae.b.getValueOrDefault(
          ...
          c.native
            ? ((c.native.enabled = !!c.native.enabled),
              (c.native.autoPrompt = c.native.hasOwnProperty("autoPrompt")
                ...
                : !!c.native.enabled),
              (c.native.pageViews = ae.b.getValueOrDefault(
                c.native.pageViews,
                qt.pageViews
              )),
              (c.native.timeDelay = ae.b.getValueOrDefault(
                c.native.timeDelay,
                qt.timeDelay
              )))
            : (c.native = {
          ...
          if (n) {
            ...
            c.slidedown.prompts = [{ type: O.Push, autoPrompt: !0, text: e }];
          } else (c.native.enabled = !0), (c.native.autoPrompt = !0);
        return (
          (c.autoPrompt =
            c.native.autoPrompt ||
            C.isSlidedownAutoPromptConfigured(c.slidedown.prompts)),
          c
        );
      }
      static getPromptOptionsForDashboardConfiguration(e) {
        ...
        return {
          autoPrompt: i.autoPrompt || C.isSlidedownAutoPromptConfigured(n),
          native: i,
          slidedown: { prompts: n },
          fullscreen: {
        ...
        switch (this.getIntegrationCapabilities(e).configuration) {
          case ai.Dashboard:
            return {
              ...
              subdomainName: i.config.Sika ANIMEInfo.proxyOrigin,
      ...
      static getSubdomainForConfigIntegrationKind(e, t, i) {
        ...
        switch (n.configuration) {
          case ai.Dashboard:
            s = i.config.Sika ANIMEInfo.proxyOriginEnabled
              ? i.config.Sika ANIMEInfo.proxyOrigin
              : void 0;
            break;
          case ai.JavaScript:
    ...
    class Ti {
      constructor(e) {
        this.options = {
          ...
          origin: e.origin,
          Sika ANIMEName: e.Sika ANIMEName,
      ...
      subscribe() {
        return Object(d.a)(this, void 0, void 0, function* () {
          const e = k.getIsPushNotificationsEnabled(),
            t = opener || parent;
          e ? t && window.close() : ge.registerForPush();
        });
      }
    }
    class Ai extends Ti {
      ...
      onProxyFrameInitializing(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          if (
            ((OneSignal.config = t),
            Xe.installNativePromptPermissionChangedHook(),
            (yield w.a.get("Options", "defaultUrl")) ||
              (yield w.a.put("Options", {
                key: "defaultUrl",
            ...
            yield Xe.initSaveState(),
            yield Xe.storeInitialValues(),
            yield Xe.saveInitOptions(),
      ...
      onMarkPromptDismissed(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          return (
            ...
            yield We.markPromptDismissedWithType(Ee.Push),
            e.reply(OneSignal.POSTMAM_COMMANDS.REMOTE_OPERATION_COMPLETE),
            !1
          );
        });
      ...
      onProcessExpiringSubscriptions(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          OneSignal.context, yield Xe.processExpiringSubscriptions();
          return (
      ...
      onSessionUpsert(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          const t = OneSignal.context,
            i = e.data;
          t.workerMessenger.directPostMessageToSW(pe.SessionUpsert, i),
            e.reply(!0);
        });
      }
      onSessionDeactivate(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          const t = OneSignal.context,
            i = e.data;
          t.workerMessenger.directPostMessageToSW(pe.SessionDeactivate, i),
            e.reply(!0);
        });
      }
      ...
      onAreYouVisibleResponse(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          const t = OneSignal.context,
            i = e.data;
          t.workerMessenger.directPostMessageToSW(pe.AreYouVisibleResponse, i),
            e.reply(!0);
        });
      }
    }
          ...
          switch (
            ...
            case X.a.OneSignalProxyFrame:
              (OneSignal.proxyFrame = new Ai(e)),
                ...
                ee.ensureBackwardsCompatibility(OneSignal);
              break;
            case X.a.OneSignalSubscriptionPopup:
      ...
      load() {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          return (
            ...
            (this.element = e),
            Object(K.x)(this.loadPromise.promise, ji.LOAD_TIMEOUT_MS).catch(
              () => {
                window === window.top &&
                  E.a.warn(
                    `OneSignal: Loading the required iFrame ${this.url.toString()} timed out. Check that the Sika ANIME URL onesignal.com dashboard web config is ${
                      location.origin
                    }. Only the Sika ANIME URL specified there is allowed to use load the iFrame.`
                  );
              }
            ),
            this.loadPromise.promise
        ...
        return Object(d.a)(this, void 0, void 0, function* () {
          E.a.debug(
            ...
            this.messenger.message(
              OneSignal.POSTMAM_COMMANDS.IFRAME_POPUP_INITIALIZE,
              {
                hostInitOptions: Object(K.h)(OneSignal.config),
    ...
    class _i {
      ...
      static getCanonicalSubscriptionUrls(e, t = T.a.getApiEnv()) {
      ...
      static getWildcardLegacySubscriptionDomain(e) {
        const t = T.a.getOneSignalApiUrl(e);
        let i = 2;
        return e === ki.a.Staging && (i = 3), ae.a.lastParts(t.host, ".", i);
      }
    ...
    class Bi {
      static setDefaultNotificationUrl(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          yield Object(K.c)(), Object(K.s)("setDefaultNotificationUrl", e);
          const t = yield w.a.getAppState();
          (t.defaultNotificationUrl = e), yield w.a.setAppState(t);
        });
      }
      static setDefaultTitle(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          yield Object(K.c)(), Object(K.s)("setDefaultTitle", e);
          const t = yield w.a.getAppState();
          (t.defaultNotificationTitle = e), yield w.a.setAppState(t);
        });
      }
      static setEmail(e, t) {
        return Object(d.a)(this, void 0, void 0, function* () {
      ...
      static isPushNotificationsSupported() {
        return Object(K.s)("isPushNotificationsSupported"), !0;
      }
      ...
      static init(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          if (
            (Object(K.s)("init"),
            yield Xe.polyfillSafariFetch(),
            Xe.errorIfInitAlreadyCalled(),
          ...
          if (!g.a.safari || Bi.config.safariWebId) {
            if (Bi.config.userConfig.requiresUserPrivacyConsent) {
              if (!(yield w.a.getProvideUserConsent()))
              ...
              if (!Bi.__initAlreadyCalled) {
                if (
                  ...
                  Bi.emitter.on(
                    ...
                    J.onNotificationPermissionChange
                  ),
                  Bi.emitter.on(
                    Bi.EVENTS.SUBSCRIPTION_CHANGED,
                    J._onSubscriptionChanged
                  ),
                  Bi.emitter.on(Bi.EVENTS.SDK_INITIALIZED, Xe.onSdkInitialized),
                  I.b.isUsingSubscriptionWorkaround())
                ) {
                ...
                window.addEventListener("focus", () => {
                  he.checkAndTriggerNotificationPermissionChanged();
                }),
                  yield Xe.initSaveState(),
                  yield Xe.saveInitOptions(),
                  T.a.getWindowEnv() === X.a.CustomIframe
                    ? yield S.a.trigger(Bi.EVENTS.SDK_INITIALIZED)
                    : yield Xe.internalInit();
              }
            });
          }
          (Bi.pendingInit = !1),
      ...
      static provideUserConsent(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          yield w.a.setProvideUserConsent(e),
      ...
      static showCategorySlidedown(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          yield Object(K.c)();
          const t = k.getIsPushNotificationsEnabled();
      ...
      static registerForPushNotifications(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          if (Bi.initialized) return yield Xe.registerForPushNotifications(e);
          yield new Promise((t, i) => {
            Bi.emitter.once(Bi.EVENTS.SDK_INITIALIZED, () =>
              Object(d.a)(this, void 0, void 0, function* () {
                return yield Xe.registerForPushNotifications(e), t();
              })
            );
          });
        });
      ...
      static getNotificationPermission(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          return yield Object(K.c)(), Bi.privateGetNotificationPermission(e);
        });
      }
      ...
      static getTags(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          yield Object(K.c)(), Object(K.s)("getTags", e);
          const { appId: t } = yield w.a.getAppConfig(),
            { deviceId: i } = yield w.a.getSubscription();
          if (!i) return E.a.info(new b(r.NoDeviceId)), null;
          const { tags: n } = yield yt.getPlayer(t, i);
          return Object(K.j)(e, n), n;
        });
      }
      ...
      static removeExternalUserId() {
        return Object(d.a)(this, void 0, void 0, function* () {
          yield Object(K.c)(),
            Object(K.s)("removeExternalUserId"),
      ...
      static addListenerForNotificationOpened(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          yield Object(K.c)(),
            Object(K.s)("addListenerForNotificationOpened", e),
            Bi.emitter.once(Bi.EVENTS.NOTIFICATION_CLICKED, (t) => {
              Object(K.j)(e, t);
            }),
            Bi.config &&
              J.fireStoredNotificationClicks(
      ...
      static getIdsAvailable(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          yield Object(K.c)(), Object(K.s)("getIdsAvailable", e);
      ...
      static isPushNotificationsEnabled(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          return yield Object(K.c)(), Bi.privateIsPushNotificationsEnabled(e);
        });
      }
      static privateIsPushNotificationsEnabled(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          Object(K.s)("isPushNotificationsEnabled", e);
          const t = yield Bi.context.subscriptionManager.getSubscriptionState();
          return (
            Object(K.j)(e, t.subscribed && !t.optedOut),
      ...
      static setSubscription(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          yield Object(K.c)(), Object(K.s)("setSubscription", e);
          const t = yield w.a.getAppConfig(),
            { appId: i } = t,
            n = yield w.a.getSubscription(),
            { deviceId: s } = n;
          ...
          const a = { notification_types: he.getNotificationTypeFromOptIn(e) },
            c = yield w.a.getExternalUserIdAuthHash();
          c && (a.external_user_id_auth_hash = c),
            (n.optedOut = !e),
            yield yt.updatePlayer(i, s, a),
            yield w.a.setSubscription(n),
            J.onInternalSubscriptionSet(n.optedOut),
            J.checkAndTriggerSubscriptionChanged();
        });
      }
      static isOptedOut(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          return yield Object(K.c)(), Bi.internalIsOptedOut(e);
        });
      }
      static internalIsOptedOut(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          Object(K.s)("isOptedOut", e);
          const { optedOut: t } = yield w.a.getSubscription();
          return Object(K.j)(e, t), t;
        });
      }
      static optOut(e, t) {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          yield Bi.setSubscription(!e), Object(K.j)(t);
        });
      }
      static getEmailId(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          yield Object(K.c)(), Object(K.s)("getEmailId", e);
          const t = (yield w.a.getEmailProfile()).subscriptionId;
          return Object(K.j)(e, t), t;
        });
      }
      static getSMSId(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          yield Object(K.c)(), Object(K.s)("getSMSId", e);
          const t = yield w.a.getSMSProfile(),
            { subscriptionId: i } = t;
          return Object(K.j)(e, i), i;
        });
      }
      static getUserId(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          yield Object(K.c)(), Object(K.s)("getUserId", e);
          const t = (yield w.a.getSubscription()).deviceId;
          return Object(K.j)(e, t), t;
        });
      }
      static getRegistrationId(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          yield Object(K.c)(), Object(K.s)("getRegistrationId", e);
          const t = (yield w.a.getSubscription()).subscriptionToken;
          return Object(K.j)(e, t), t;
        });
      }
      static getSubscription(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          return yield Object(K.c)(), yield Bi.privateGetSubscription(e);
        });
      }
      static privateGetSubscription(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          Object(K.s)("getSubscription", e);
          const t = !(yield w.a.getSubscription()).optedOut;
          return Object(K.j)(e, t), t;
        });
      }
      static sendSelfNotification(
        ...
        return Object(d.a)(this, void 0, void 0, function* () {
          if (
            (yield Object(K.c)(),
            Object(K.s)("sendSelfNotification", e, t, i, n, s, a),
            !(yield w.a.getAppConfig()).appId)
          )
          ...
          const c = (e) => {
            ...
            l = { data: s, url: i, buttons: a ? c(a) : void 0 };
          this.context.serviceWorkerManager.getRegistration().then((i) =>
            Object(d.a)(this, void 0, void 0, function* () {
              if (!i)
                return void E.a.error(
                  "Service worker registration not available."
                );
              const o = { body: t, data: l, icon: n, actions: a ? c(a) : [] };
      ...
      static sendOutcome(e, t) {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          const n = new ht(Bi.config.appId, i, e, !1);
    ...
    (Bi.VERSION = h.a.version()),
      ...
      ee.ensureBackwardsCompatibility(Bi),
      E.a.info(
